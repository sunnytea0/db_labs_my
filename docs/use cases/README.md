...
| **Основний сценарій:** | 1. Користувач відкриває опитування <br> 2. Відповідає на всі питання і надає зворотний зв’язок <br> 3. Завершує проходження <br> 4. Система перевіряє коректність заповнення (може виникнути IncompleteSurveyException) <br> 5. Відповіді зберігають у базі даних |
...
@startuml
    ...
    :відповіді зберігають у базі даних;
