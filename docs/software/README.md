...
('Java Basics', 'Основи програмування на Java'),
('SQL Starter', 'Вступ до реляційних баз даних');

INSERT INTO "Question" (quiz_id, header, description) VALUES
((SELECT id FROM "Quiz" WHERE title='Java Basics'), 'Що таке JVM?', 'Коротко поясніть суть JVM.'),
((SELECT id FROM "Quiz" WHERE title='SQL Starter'), 'Що таке PRIMARY KEY?', 'Опишіть значення первинного ключа.');

INSERT INTO "Type" (question_id, description) VALUES
((SELECT id FROM "Question" WHERE header='Що таке JVM?'), 'Open-ended'),
((SELECT id FROM "Question" WHERE header='Що таке PRIMARY KEY?'), 'Multiple choice');

INSERT INTO "Variant" (question_id, text, is_correct) VALUES
((SELECT id FROM "Question" WHERE header='Що таке PRIMARY KEY?'), 'Унікальний ідентифікатор записів', TRUE),
