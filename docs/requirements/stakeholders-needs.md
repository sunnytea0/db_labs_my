...
| **Основний сценарій:** | 1. Система перевіряє список активних опитувань користувача <br> 2. Якщо є незавершені опитування, надсилається нагадування користувачу <br> 3. Користувач отримує повідомлення про необхідність завершити опитування |
...
| **Основний сценарій:** | 1. Користувач обирає опитування для видалення <br> 2. Надсилає запит на видалення <br> 3. Система перевіряє права доступу (може виникнути помилка AccessDeniedException) <br> 4. Система видаляє опитування (може виникнути SurveyNotFoundException) <br> 5. Користувач отримує підтвердження на видалення |
